  ...
  useGetCompanyById(params.id)
    ...
    const submitHandler = async (e)=>{
           e.preventDefault();
                   ...
                   // Fetch current company data from state or API
    const currentData = { name: input.name, description: input.description, website: input.website, location: input.location };

    // Check if any changes were actually made
    const isUpdated = Object.keys(currentData).some(key => currentData[key] !== input[key]);
